...
import GridCard from "../../components/GridCard/GridCardDeath";
import styles from "./ProfilePage.module.css";

export const ProfilePageDeath = () => {
    ...
    return (
        <div>
            {/* Personal Info */}
            <div className={`flex items-center justify-start p-4 ${styles.personalInfoContainerDeath}`}>
                ...
                <div className="ml-12 text-black">
                    <h2 className="text-2xl text-white font-bold mb-1">Profile</h2>

                    {isEditing ? (
                        // Edit Mode
                        <>
                            <div className="flex mb-2">
                                <p className="w-32 text-white">Username</p>
                                <input
                                    type="text"
                                    name="username"
                            ...
                            <div className="flex mb-2">
                                <p className="w-32 text-white">Full Name</p>
                                <input
                                    type="text"
                                    name="fullName"
                            ...
                            <div className="flex mb-2">
                                <p className="w-32 text-white">Email</p>
                                <input
                                    type="email"
                                    name="email"
                            ...
                            <div className="mt-4">
                                <button
                                    onClick={handleSave}
                                    className={`px-4 py-2 text-white rounded mr-2 ${styles.editButtonStyle} ${styles["button-saveDeath"]}`}
                                >
                                    Save
                                </button>
                                <button
                        ...
                        <>
                            ...
                            <div
                                onClick={handleEdit}
                                className={`mt-4 px-5 py-2 flex items-center text-white cursor-pointer ${styles.editButtonStyleDeath}`}
                            >
                                <img
            ...
            <div className={styles.savedContainerDeath}>
                {/* Tips Section */}
                <div className="flex gap-5 ml-64">
                    <div className="text-center mt-6">
                        <p className="mb-2 text-white">Tips Created</p>
                        <div className={styles.tipsCreatedBar}></div>
                    </div>
                    <div className="text-center mt-6">
                        <p className="mb-2 text-white">Tips Saved</p>
                        <div className={styles.tipsSavedBarDeath}></div>
                    </div>
                </div>
