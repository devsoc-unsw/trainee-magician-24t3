        ...
        <div className="flex flex-col items-center">
            ...
            <div className="w-1/2">
                ...
                <input
                    ...
                    className="w-full h-12 px-4 mb-4 border border-black rounded-lg focus:outline-none focus:border-green-500"
                />
                ...
                {/* Content Input */}
                <textarea
                    className="w-full h-80 px-4 py-2 border border-black rounded-lg resize-none mb-2 focus:outline-none focus:border-green-500"
                />

                {/* Upload Button */}
                <div className="flex items-center mb-5">
                    <button
                        className="flex items-center justify-center w-10 h-10 border border-black rounded-lg mr-2"
                    >
                ...
                <div className="relative">
                    ...
                    ></div>
                    <button className="relative px-6 py-3 bg-green-500 text-black font-bold rounded-lg hover:bg-green-600">
                        Publish
                    </button>
                </div>
            </div>
